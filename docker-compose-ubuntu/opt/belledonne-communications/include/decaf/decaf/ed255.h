...
extern const DECAF_API_VIS uint8_t * const DECAF_ED25519_NO_CONTEXT;

#else
#define DECAF_EDDSA_25519_SUPPORTS_CONTEXTLESS_SIGS 1
DECAF_API_VIS extern const uint8_t * const DECAF_ED25519_NO_CONTEXT;
 ...
 */    
void DECAF_API_VIS decaf_ed25519_derive_public_key (
 ...
 * you no seat belt.
 */  
void DECAF_API_VIS decaf_ed25519_sign (
 ...
 * you no seat belt.
 */  
void DECAF_API_VIS decaf_ed25519_sign_prehash (
    uint8_t signature[DECAF_EDDSA_25519_SIGNATURE_BYTES],
    const uint8_t privkey[DECAF_EDDSA_25519_PRIVATE_BYTES],
    const uint8_t pubkey[DECAF_EDDSA_25519_PUBLIC_BYTES],
 ...
 */
void DECAF_API_VIS decaf_ed25519_prehash_init (
 ...
 * you no seat belt.
 */
decaf_error_t DECAF_API_VIS decaf_ed25519_verify (
 ...
 * you no seat belt.
 */
decaf_error_t DECAF_API_VIS decaf_ed25519_verify_prehash (
    const uint8_t signature[DECAF_EDDSA_25519_SIGNATURE_BYTES],
    const uint8_t pubkey[DECAF_EDDSA_25519_PUBLIC_BYTES],
    const decaf_ed25519_prehash_ctx_t hash,
    const uint8_t *context,
 ...
 */       
void DECAF_API_VIS decaf_255_point_mul_by_ratio_and_encode_like_eddsa (
 ...
 * @param [in] p The point.
 */       
decaf_error_t DECAF_API_VIS decaf_255_point_decode_like_eddsa_and_mul_by_ratio (
    decaf_255_point_t p,
 ...
 */
void DECAF_API_VIS decaf_ed25519_convert_public_key_to_x25519 (
 ...
 */
void DECAF_API_VIS decaf_ed25519_convert_private_key_to_x25519 (
